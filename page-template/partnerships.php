...
?>
    <main role="main">
        <section>
            ...
            <div id="flex-component-<?php echo $i++; ?>" class="ui-hero small">

                <div class="ui-hero-slides regular-version" data-speed="6000">
                    <div class="ui-hero-slide fixed animated center" style="background-image:url('<?php echo $partnership_banner_bg; ?>');z-index:1;">
                            ...
                            <div class="ui-hero-slide-container regular-version center">
                                <div class="container">
                                    <div class="ui-hero-slide-content">
                                        ...
                                        <div class="ui-hero-slide-content-action-buttons"></div>
                                    </div>
            ...
            <?php if (!empty($accordion_main_title)): ?>
                <div id="flex-component-<?php $i++; ?>" class="ui-editorial">
                    <div class="container">
            ...
            <div class="partnership_accordion_wrapper">
                ...
                foreach ((array)$partner_accordion_group as $key => $entry) :
                    ...
                    if (!empty($entry['accordion_title'])) {$accord_title = $entry['accordion_title'];}
                    if (!empty($entry['accordion_desc'])) {$accord_desc = $entry['accordion_desc'];}
                    if (!empty($entry['accordion_btn'])) {$accord_btn = $entry['accordion_btn'];}
                    if (!empty($entry['accordion_url'])) {$accord_btn_url = $entry['accordion_url'];} ?>

                    <div class="ui-drawer center" style="background-image:url('https://greatergood.org/wp-content/uploads/2019/04/ggo-blue.png');">
                                        ...
                                        <div class="accordion-content">
                                            ...
                                            <div>
                                                <div class="ui-drawer-content-action-button ">
                                                    <a href="mailto:<?php echo $accord_btn_url; ?>"
                    ...
                    <div class="ui-emergency-action" style="background-color:#32aad8">
                        <div class="ui-emergency-action-content"><span style="color:#ffffff" class="ui-emergency-action-text"><strong></strong></span>
                        </div>
                    </div>
            ...
            <div id="flex-component-9" class="ui-hero small">
                ...
                <div class="ui-hero-slides regular-version" data-speed="6000">
                    <div class="ui-hero-slide fixed animated center" style="background-image:url('<?php echo $partnership_parallax_bg ?>');z-index:1;">
